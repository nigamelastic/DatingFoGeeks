...
(async () => {
    ...
    if (fileExists) {
        ...
        await page.goto('https://www.okcupid.com/home', { "waitUntil": "networkidle0" });
        await page.waitForSelector('#navigation > div.nav-left > ul > li:nth-child(1) > a')

    } else {
        console.log("file doesnt exist");
        await page.goto('https://www.okcupid.com', { "waitUntil": "networkidle0" });
    ...
    await page.waitForSelector('#match_results > span:nth-child(1) > div > a:nth-child('+1+') > div > div.usercard-thumb > span > img')
    await page.click('#match_results > span:nth-child(1) > div > a:nth-child('+1+') > div > div.usercard-thumb > span > img')
